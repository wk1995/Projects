 ...
 * */
class IdeaAdapter(private var beans: MutableList<ScheduleIdeaBean>? = null) : RecyclerView.Adapter<IdeaAdapter.IdeaViewHolder>() {
    class IdeaViewHolder(val v: View, val textView: TextView) : RecyclerView.ViewHolder(v)
